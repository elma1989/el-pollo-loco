export class ImgHelper {
    ...
    static STATUSBAR = {
        ...
        bottles: [
            'assets/img/statusbar/bottles/0.png',
            'assets/img/statusbar/bottles/20.png',
            'assets/img/statusbar/bottles/40.png',
            'assets/img/statusbar/bottles/60.png',
            'assets/img/statusbar/bottles/80.png',
            'assets/img/statusbar/bottles/100.png'
        ],
        coins : [
            'assets/img/statusbar/coins/0.png',
            'assets/img/statusbar/coins/20.png',
            'assets/img/statusbar/coins/40.png',
            'assets/img/statusbar/coins/60.png',
            'assets/img/statusbar/coins/80.png',
            'assets/img/statusbar/coins/100.png'
        ],
        boss: [
            'assets/img/statusbar/boss/0.png',
            'assets/img/statusbar/boss/20.png',
            'assets/img/statusbar/boss/40.png',
